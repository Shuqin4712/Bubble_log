...
- **每日照片**：记录面板内「📷 这天的照片」从相册选图，作为该日在月报明细日历和海报上的**格子底图**（照片上自动压暗色蒙版保证数字可读）；紧凑日历上配了照片的日子右下角有小圆点标记。日历格是 **3:4 竖版**，手机竖着拍的照片贴上去不会被裁掉半个人
...
└── photos/            # 每日照片（可选）
    └── 2026-07-04.jpg # 裁成 306x408（3:4），约 50~80KB/张
```

每日照片按需存放，没配照片的日子不占空间。一年每天都配的话约 20MB。
